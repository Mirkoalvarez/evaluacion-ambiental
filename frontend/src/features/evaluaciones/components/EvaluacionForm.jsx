...
import { crearEvaluacion } from '../slice';
import { listarBarrios } from '../../barrios/slice';
            ...
            <div className="col-12 mt-4">
                <div className="section-energia">
                    ...
                    <div className="row g-3">
                        ...
                        <div className="col-md-4" key={name}>{renderQuestion(name, SINO)}</div>
                        ))}
                        {['e1_4', 'e1_5'].map(name => (
                        <div className="col-md-4" key={name}>{renderQuestion(name, NPT)}</div>
                        ))}
            ...
            <div className="col-12 mt-4">
                <div className="section-agua">
                    ...
                    <div className="row g-3">
                        ...
                        <div className="col-md-3" key={name}>{renderQuestion(name, SINO)}</div>
                        ))}
                    </div>
                </div>
            </div>
            ...
            <div className="col-12 mt-4">
                <div className="section-residuos">
                    ...
                    <div className="col-md-4">
                        ...
                        <input className="form-control" type="number" min="0" step="1" name="r3_3" value={form.r3_3} onChange={onChange} />
                    </div>
